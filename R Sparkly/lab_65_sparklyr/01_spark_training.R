...
#options(sparklyr.log.console = TRUE) # enable this for trouble shooting purposes
options(sparklyr.verbose = TRUE)  # <- maybe should enable this as well
